...
@:expose
class Utils {
	static public inline var SQRT3 : Float = 1.7320508075688772935;
	static public inline var OctavesMaximum = 30;
	static public inline var Deg2Rad = 0.01745329251;

	#if NOISE_VERSION_1
	static private var GeneratorNoiseX : Int = 1;
	static private var GeneratorNoiseY : Int = 31337;
	static private var GeneratorNoiseZ : Int = 263;
	static private var GeneratorSeed : Int = 1013;
	static private var GeneratorShift : Int = 13;
	#else
	static private var GeneratorNoiseX : Int = 1619;
	static private var GeneratorNoiseY : Int = 31337;
	static private var GeneratorNoiseZ : Int = 6971;
	static private var GeneratorSeed : Int = 1013;
	...
	static public function GradientCoherentNoise3D(x : Float, y : Float, z : Float, seed : Int, quality : QualityMode) : Float {
		...
		var x1 = x0 + 1;
		var y0 = y > 0.0 ? Std.int(y) : Std.int(y) - 1;
		var y1 = y0 + 1;
		var z0 = z > 0.0 ? Std.int(z) : Std.int(z) - 1;
		var z1 = z0 + 1;
		var xs = 0.0;
		var ys = 0.0;
		var zs = 0.0;
	...
	static public inline function MapCubicSCurve(value : Float) : Float {
	...
	static public inline function ValueNoise3D(x : Int, y : Int, z : Int, seed : Int) : Float {
		return 1.0 - (ValueNoise3DInt(x, y, z, seed) / 1073741824.0);
	}

	static public function ValueNoise3DInt(x : Int, y : Int, z : Int, seed : Int) : Int {
		var n = (GeneratorNoiseX * x + GeneratorNoiseY * y + GeneratorNoiseZ * z + GeneratorSeed * seed ) & 0x7fffffff;
		n = (n >> 13 ) ^ n;
